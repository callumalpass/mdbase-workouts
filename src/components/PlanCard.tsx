...
export default function PlanCard({ plan, onStartWorkout }: Props) {
  ...
  return (
    <div className="ledger-card ledger-card-blush active:translate-y-px transition-transform">
      ...
      {plan.status === "scheduled" && onStartWorkout && (
        <button
          ...
          className="w-full py-2.5 bg-blush text-paper text-xs font-mono font-medium
